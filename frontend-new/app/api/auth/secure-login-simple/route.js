...
import { secureLog, secureError, secureWarn, secureInfo } from '@/lib/secure-logging.js';

/**
 * Simple secure login endpoint with comprehensive security measures
 * This provides a working alternative to the complex wrapper system
 */
...
export async function POST(request) {
  try {
    ...
    if (!email || !password || !role) {
      secureWarn('Login attempt with missing credentials', { email, role, ip });
    ...
    secureError('Secure login error', error);
